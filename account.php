...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-default navbar-light mb-10" style="background-color: rgba(105, 105, 105, 0.8);">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: large;">
                        <a class="nav-item nav-link text-dark mr-5  " href="staff.php">กลับ</a>
                        <a class="nav-item nav-link text-dark" href="logout.php" >ออกจากระบบ</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container text-center" style="width : 50%; background-color: rgba(255, 255, 255, 0.7); margin-top: 10px; border-radius:15px; padding: 5px;">
            ...
            <img src="Images/profile.png" style="margin:0 auto; height: 140px; width: 140px; margin-bottom: 15px;">
            <table class="text-left table table-bordered table-striped" >
                <tr><td style="font-weight:bold;">ชื่อ</td><td><?php echo $staff['Name']; ?></td></tr>
                <tr><td style="font-weight:bold;">ไอดีพนักงาน</td><td><?php echo $staff['StaffID']; ?></td></tr>
                <tr><td style="font-weight:bold;">ตำแน่ง</td><td><?php echo $staff['Designation']; ?></td></tr>
                <tr><td style="font-weight:bold;">เพศ</td><td><?php echo $staff['Gender']; ?></td></tr>
                <tr><td style="font-weight:bold;">วันเกิด</td><td><?php echo $staff['DOB']; ?></td></tr>
                <tr><td style="font-weight:bold;">วันที่เริ่มทำงาน</td><td><?php echo $staff['DOJ']; ?></td></tr>
                <tr><td style="font-weight:bold;">Email</td><td><?php echo $staff['Email']; ?></td></tr>
                <tr><td style="font-weight:bold;">เบอร์โทรศัพท์</td><td><?php echo $staff['Mobile']; ?></td></tr>
                <tr><td style="font-weight:bold;">เครดิต</td><td><?php echo $staff['Credits']; ?></td></tr>
            </table>
        </div>
