    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: large;">
                        ...
                        <a class="nav-item nav-link text-dark mr-5 active" href="#">สาขา</a>
        ...
        <div class="container">
            ...
            <?php foreach($branches as $branch) : ?>
                ...
                <div class="p-3 col-12" style="background-color: rgba(255, 255, 255, 0.7); box-shadow: 0 30px 50px rgba(0,0,0,.2); margin-top:5px !important;">
                    <ul style="list-style-type:none;">
                        <li><a href="#" class="fa fa-map-marker m-1" style="pointer-events: none; color:red;"></a><?php echo '  '.$branch['Address']; ?></li>
                        <li><a href="#" class="fa fa-phone m-1"      style="pointer-events: none; color:red;"></a><?php echo '  '.$branch['Contact']; ?></li>
                        <li><a href="#" class="fa fa-envelope m-1"   style="pointer-events: none; color:red;"></a><?php echo '  '.$branch['Email']; ?></li>
                    </ul>
                </div>
            <?php endforeach; ?>
            </div>
