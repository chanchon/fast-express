<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(array_filter($errors)){
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                echo "setTimeout(function () { swal('Service Not Available', 'Fast Express จะถึงที่ของคุณในเร็วๆนี้ !!', 'info');";
                echo '}, 1000);</script>';
            }
        }
    }
    ...
    if(isset($_POST['update'])){
        ...
        }elseif($checked == 'Sending'){
            $sql = "UPDATE status SET Sending=CURRENT_TIMESTAMP WHERE TrackingID='$inp_tid' ";
...
<html>
    ...
    <body style="font-family: Tahoma, sans-serif">
        <div class="container-fluid">
            <div class="row">
                <div class="col-10"><img src="Images/fa.png" id="logo" style="height: 100px !important; margin-top: 10px !important; margin-left:10px !important; " ></div>
                <div class="col-2 dropdown">
                    <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" >
                        <img src="Images/profile.png" id="logo" style="height: 85px !important;" >
                        <span><?php echo $name ?></span>
                    </button>
                    <ul class="dropdown-menu text-center" id="dd-menu">
                        <li><div><a href="account.php" style="color: black; text-decoration: none;">บัญชีของฉัน</a></div></li>
                        <li><div><a href="logout.php" style="color: black; text-decoration: none;">ออกจากระบบ</a></div></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-10">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" id="ins-tab" data-toggle="tab" href="#ins" role="tab" aria-controls="ins" aria-selected="true" style="color: black;">ออเดอร์ใหม่</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="update-tab" data-toggle="tab" href="#update" role="tab" aria-controls="update" aria-selected="false" style="color: black;">อัพเดตออเดอร์</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="cons-tab" data-toggle="tab" href="#cons" role="tab" aria-controls="cons" aria-selected="false" style="color: black;">รายละเอียดการส่ง</a>
                </li>
              </ul>
              <div class="tab-content" id="myTabContent">
                    ...
                    <div class="container">
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form" method="POST">
                            ...
                            <div class="col-md-6 p-3" style="background-color: rgba(255, 255, 255, 0.7);">
                                <h3 class="mb-3">รายละเอียดผู้ส่ง</h3>
                            ...
                            <div class="col-md-6 p-3" style="background-color: rgba(255, 255, 255, 0.7);">
                                <h3 class="mb-3">รายละเอียดผู้รับ</h3>
                                <div class="form-group text-left pl-5">
                                    <label>ชื่อ : </label>
                                ...
                                <input type="submit" name="submit" value="ตกลง" style="font-size: 20px"; class="btn btn-danger">
                            </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="tab-pane fade" id="update" role="tabpanel" aria-labelledby="update-tab">
                    <div class="container mt-10">
                        <div class="row">
                            <div class="col-4 p-4 text-center pt-0" style="background-color: rgba(192, 192, 192, 0.7); margin-top: 20px;">
                                 <form action="" method="POST" class="form">
                                    <div class="form-group">
                                        <label style="font-size: 20px;">เลขพัสดุ : </label><br>
                                    ...
                                    <input type="submit" name="sel_order" class="btn btn-success text-center" value="ตกลง" style="font-size: 20px;">
                                </form>
                            </div>
                            <div class="col-8 p-4 " style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px; ">
                                <h3 class="display-6 text-center pb-2 mb-3" style="border-bottom: 2px solid black;">รายละเอียดการจัดส่ง</h3>
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>ฟาสเข้ารับพัสดุแล้ว  </label>
                                        <?php echo $status['disp']; ?>
                                    </div>
                                    <div class="form-group">
                                        <input type='checkbox' name='status_upd' value ="shipped" <?php echo $disable_ship ?>>
                                        <label>อยู่ระหว่างขนส่ง </label>
                                        <?php echo $status['ship']; ?>
                                    </div>
                                    <div class="form-group">
                                        <input type='checkbox' name='status_upd' value ="Sending" <?php echo $disable_out ?>>
                                        <label>กำลังจัดส่งพัสดุ  </label>
                                        <?php echo $status['out']; ?>
                                    </div>
                                    <div class="form-group">
                                        <input type='checkbox' name='status_upd' value ="delivered" <?php echo $disable_del ?>>
                                        <label>พัสดุจัดส่งสำเร็จ  </label>
                                        <?php echo $status['del']; ?>
                                    </div>
                                    <input type="submit" name="update" value="อัพเดต" class="btn btn-success">
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="cons" role="tabpanel" aria-labelledby="cons-tab">
                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                        <li class="nav-item" role="presentation">
                          <a class="nav-link active" id="arr-tab" data-toggle="tab" href="#arr" role="tab" aria-controls="arr" aria-selected="true" style="color: black;">การจัดส่ง</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="del-tab" data-toggle="tab" href="#del" role="tab" aria-controls="del" aria-selected="false" style="color: black;">ส่งถึงแล้ว</a>
                        </li>
                      </ul>
                        ...
                        <div class="tab-pane fade show active" id="arr" role="tabpanel" aria-labelledby="arr-tab">
                            <table class="table table-hover table-bordered table-striped table-hover" style="background-color: rgba(255, 255, 255, 0.8);">
                                <thead class="thead-dark">
                                    <tr class="table-info"><td>เลขพัสดุ</td><td>ไอดีพนักงาน</td><td>ผู้ส่ง</td><td>ผู้รับ</td><td>น้ำหนัก</td><td>ราคา</td><td>ฟาสเข้ารับพัสดุแล้ว</td><td>อยู่ระหว่างขนส่ง</td><td>กำลังจัดส่งพัสดุ</td><td>พัสดุจัดส่งสำเร็จ</td></tr>                    
                                </thead>
                                <tbody>
